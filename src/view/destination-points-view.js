...
<li class="trip-events__item">
  <div class="event">
    <time class="event__date" datetime="${dateFrom}">${dateFromHum}</time>
    ...
    <div class="event__schedule">
      <p class="event__time">
        <time class="event__start-time" datetime="${dateFrom}">${timeFromHum}</time>
        &mdash;
        <time class="event__end-time" datetime="${dateTo}">${timeToHum}</time>
      </p>
    </div>
